...
public class SeatApiController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Список мест получен")
    })
    @GetMapping
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Место создано"),
        @ApiResponse(responseCode = "400", description = "Ошибка валидации или место с такими координатами уже существует",
            content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    @PostMapping
